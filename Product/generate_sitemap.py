...
def registerDoctorsSiteMaps():
    if not os.path.exists('static/assets/sitemaps/doctors'):
        os.makedirs('static/assets/sitemaps/doctors')
    root = ET.Element('urlset')
    root.attrib['xmlns:xsi']="http://www.w3.org/2001/XMLSchema-instance"
    root.attrib['xsi:schemaLocation']="http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd"
    root.attrib['xmlns']="http://www.sitemaps.org/schemas/sitemap/0.9"
    ...
    # Write the prettified XML to the file
    with open('static/assets/sitemaps/doctors/doctors_sitemap.xml', 'w', encoding='utf-8') as f:
        f.write(pretty_xml)