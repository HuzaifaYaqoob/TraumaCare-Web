...
class CustomUserAdmin(UserAdmin):
    ...
    def phone_number(self, user):
        image_html_tag = '<img style="margin-right:7px" src="%s" />' % ('https://traumaaicare.com/static/admin/img/icon-yes.svg' if obj.is_mobile_verified else 'https://traumaaicare.com/static/admin/img/icon-no.svg')
        return mark_safe(f'{image_html_tag} {obj.mobile_number}')
