...
def generatePhoneMessage_VerificationCode(sender, instance, created, **kwargs):
    if created and instance.otp_type == 'MOBILE_VERIFICATION':
        ...
        PhoneMessage.objects.create(
            ...
            sms_type = 'OTP',
            text = f"Your TraumaCare verification code is {instance.code}. Don't share this code with anyone.\nThanks for choosing TraumaCare, an innovative healthcare solution by RedExpo."
        )
